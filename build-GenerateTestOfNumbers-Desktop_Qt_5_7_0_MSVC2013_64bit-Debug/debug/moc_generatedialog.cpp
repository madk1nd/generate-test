...
#include "../../GenerateTestOfNumbers/generatedialog.h"
...
QT_MOC_LITERAL(1, 15, 15), // "getFullFileName"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 12) // "generateTest"

    },
    "generatedialog\0getFullFileName\0\0"
    "generateTest"
};
...
void generatedialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getFullFileName(); break;
        case 1: _t->generateTest(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject generatedialog::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_generatedialog.data,
      qt_meta_data_generatedialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *generatedialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_generatedialog.stringdata0))
        return static_cast<void*>(const_cast< generatedialog*>(this));
    if (!strcmp(_clname, "Ui::generatedialog"))
        return static_cast< Ui::generatedialog*>(const_cast< generatedialog*>(this));
